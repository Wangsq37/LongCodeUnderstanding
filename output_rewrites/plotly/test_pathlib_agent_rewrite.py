...
# Augmented test data: larger and more complex figure
fig = {
    "data": [
        {"type": "scatter", "x": [1, 2, 3, 4, 100000], "y": [-1, 0, 999999, 4, 2], "name": "edge-case"},
        {"type": "bar", "x": [0, -10, 100], "y": [0, 9999999, -1]}
    ],
    "layout": {"title": {"text": ""}, "xaxis": {"range": [-1e12, 1e12]}, "yaxis": {"range": [-1e6, 1e6]}}
}
