...
def test_self_adversarial_negative_sampling(temperature):
    # Augmented diverse/edge case: includes zero, negatives, large/small floats, repeated labels, and odd label value
    ...
    logit_scores = np.array([
        ...
        13.5,          # extremely large positive
        -13.5,         # extremely large negative
        2.3,           # positive
        -2.3           # negative
    ], dtype=np.float32)
