...
def test_init_from_list():
    # Augmented: includes empty string, negative, zero, float as groupers
    g = GroupBy(["", 0, -5, 1.23, "Z"])
    assert g.order == {"": None, 0: None, -5: None, 1.23: None, "Z": None}


def test_init_from_dict():
    # Augmented: includes floats, negative, and empty string as keys/values
